...
ID = "2023-12-24T17:40:31:294545"
VERSION = "1.2.0"
DESCRIPTION = "Required tables for 'Auth.js' oAuth/OIDC"
...
async def forwards():
    ...
    manager.add_table(
        class_name="Account", tablename="accounts", schema=None, columns=None
    )
    ...
    manager.add_column(
        table_class_name="User",
        tablename="users",
        column_name="updated_dt",
        db_column_name="updated_dt",
        column_class_name="Timestamptz",
        column_class=Timestamptz,
        params={
            "default": TimestamptzNow(),
    ...
    manager.add_column(
        ...
        db_column_name="providerAccountId",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 100,
    ...
    manager.add_column(
        table_class_name="VerificationToken",
        tablename="verification_tokens",
        column_name="id",
        db_column_name="id",
        column_class_name="UUID",
